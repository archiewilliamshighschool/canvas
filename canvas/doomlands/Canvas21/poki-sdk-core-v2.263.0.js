(() => {
    ...
    i.n = e => {
                            ...
                            if (s) {
                                ...
                                if (1 !== d && (!k || !k.videoCacheKey || k.cpm < B(o))) {
                                    ...
                                    "ninja.io" === (null === (g = null === window || void 0 === window ? void 0 : window.location) || void 0 === g ? void 0 : g.hostname) && (S = function(e) {
                                        ...
                                        cpm: S,
                                        vast: "null.html?about:blank" + ("" === $e.gameId ? "" : "?game_id=" + $e.gameId),
                                        bidder: "poki",
                                        videoCacheKey: "poki"
                                    }
                                }
        ...
        function $() {
            ...
            return "yes" === I("poki-ad-server") ? (console.log("DEBUG: Only running Poki-ad-server"), !0) : "localhost" !== t && "sigma" !== t && !t.endsWith(".poki-gdn.com") && ("ninja.io" === t ? Math.random() <= .5 : "venge.io" === t ? Math.random() <= .05 : "makeitmeme.com" === t)
        }
        var ee = function() {
            function e(e, t) {
        ...
        const je = function() {
            ...
            return fetch("null.html?about:blank" + t + "&referrer=" + i, {
                method: "GET",
                headers: {
                ...
                return Oe(this, (function(s) {
                    switch (s.label) {
                        case 0:
                            ...
                            s.label = 1;
                        case 1:
                            return s.trys.push([1, 4, , 5]), [4, fetch("null.html?about:blank", {
                                method: "GET",
                                headers: {
                ...
                return Ue(void 0, void 0, void 0, (function() {
                    ...
                    return Ze(this, (function(n) {
                        switch (n.label) {
                            ...
                            case 3:
                                return (e = n.sent()) && ((t = document.createElement("script")).src = "//about:blank", t.onload = function() {
        ...
        var Je = function() {
            ...
            et = function() {
                ...
                return e.prototype.init = function(e) {
                    ...
                    var T = [k(), S()],
                        _ = Ye(Ye([], T, !0), [Ge()], !1);
                    this.isBot || (_.push(Pe("null.html?https://imasdk.googleapis.com/js/sdkloader/ima3.js"), Pe("null.html?about:blank")), (I("url_referrer") || "").includes("kiloo.com") ? (e.prebidAvailable = !1, e.childDirected = !0, e.nonPersonalized = !0, this.IGD.enforceChildSafety()) : _.push(Pe("null.html?about:blank"), Pe("null.html?about:blank")));
